...
public class DenverPittsburg1 : MonoBehaviour
{
    ...
    {
        if ((DK.activeSelf || DK1.activeSelf || DO.activeSelf || DS.activeSelf || DP.activeSelf || DS1.activeSelf || DS2.activeSelf || DH.activeSelf) && (PN2.activeSelf|| PR.activeSelf||PC.activeSelf||PC1.activeSelf|| PS.activeSelf|| PN1.activeSelf||PW.activeSelf || PN.activeSelf || PT.activeSelf) && player2Stuff.activeSelf)
        {
