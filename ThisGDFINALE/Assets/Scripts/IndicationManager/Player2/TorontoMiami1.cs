...
public class TorontoMiami1 : MonoBehaviour
{
    ...
    {
        if ((TP.activeSelf || TM.activeSelf || TC.activeSelf || TD || TS.activeSelf) && (MC.activeSelf || MA.activeSelf || MN.activeSelf) && player2Stuff.activeSelf)
        {
