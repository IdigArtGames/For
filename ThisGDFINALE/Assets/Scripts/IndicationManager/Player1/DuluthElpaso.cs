...
public class DuluthElpaso : MonoBehaviour
{
    ...
    {
        if ((DO.activeSelf || DC.activeSelf || DT.activeSelf || DS.activeSelf|| DW.activeSelf|| DH.activeSelf) && (EO.activeSelf || ES.activeSelf || EP.activeSelf || EH.activeSelf || ED.activeSelf || EL.activeSelf) && player1Stuff.activeSelf)
        {
