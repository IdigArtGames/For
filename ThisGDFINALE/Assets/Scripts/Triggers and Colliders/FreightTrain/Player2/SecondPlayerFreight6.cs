...
public class SecondPlayerFreight6 : MonoBehaviour
{
    //refs
    ...
    public CabooseTrain6 cabooseTrain6;
    ...
    private void Update()
    {
        if (isTriggered && Input.GetMouseButtonUp(0) && cabooseTrain6.bc.isActiveAndEnabled)
        {
