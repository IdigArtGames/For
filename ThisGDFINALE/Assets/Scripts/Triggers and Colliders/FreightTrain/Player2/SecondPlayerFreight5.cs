...
public class SecondPlayerFreight5 : MonoBehaviour
{
    //refs
    ...
    public CabooseTrain5 cabooseTrain5;
    ...
    private void Update()
    {
        if (isTriggered && Input.GetMouseButtonUp(0) && cabooseTrain5.bc.isActiveAndEnabled)
        {
