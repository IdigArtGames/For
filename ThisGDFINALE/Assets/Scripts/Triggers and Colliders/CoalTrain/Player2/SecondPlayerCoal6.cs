...
public class SecondPlayerCoal6 : MonoBehaviour
{
    //refs
    ...
    public TankerTrain5 tankerTrain5;
    ...
    private void Update()
    {
        if (isTriggered && Input.GetMouseButtonUp(0) && tankerTrain5.bc.isActiveAndEnabled)
        {
