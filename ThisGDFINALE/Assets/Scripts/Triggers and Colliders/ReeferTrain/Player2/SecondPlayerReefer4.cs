...
public class SecondPlayerReefer4 : MonoBehaviour
{
    //refs
    ...
    public PassengerTrain6 passengerTrain6;
    ...
    private void Update()
    {
        if (isTriggered && Input.GetMouseButtonUp(0) && passengerTrain6.bc.isActiveAndEnabled)
        {
