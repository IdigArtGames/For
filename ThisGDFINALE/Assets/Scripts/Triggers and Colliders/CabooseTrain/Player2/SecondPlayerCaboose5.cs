...
public class SecondPlayerCaboose5 : MonoBehaviour
{
    //refs
    ...
    public FreightTrain5 freightTrain5;
    ...
    private void Update()
    {
        if (isTriggered && Input.GetMouseButtonUp(0) && freightTrain5.bc.isActiveAndEnabled)
        {
